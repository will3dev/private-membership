...
describe("Direct Verifier Test", function () {
    ...
    it("should verify CLI-generated proof directly", async function () {
        ...
        console.log("Testing verifier with CLI proof:");
        console.log("Proof A:", proofPoints.a);
        console.log("Proof B:", proofPoints.b);
        console.log("Proof C:", proofPoints.c);
